...
public class SendFile implements Runnable {
	...
	public void run() {
		try {
			...
			privateChat.insertLine(
					language.getValue("DOWNLOAD_OF") + " " + sentFile.getName() + " " + language.getValue("STARTED"),
			...
			socket.close();
			privateChat.insertLine(
					language.getValue("DOWNLOAD_OF") + " " + sentFile.getName() + language.getValue("FINISHED"),
					privateChat.getTransfer(), true);
