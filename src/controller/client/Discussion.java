...
public class Discussion extends JTextPane implements Runnable {
	...
	/**
	 * Constructor of discussion
	 * 
	 * @param infos
	 * @param od
	 * @param language
	 */
	public Discussion(InformationServer infos, AllChat od, Language language) {
		...
		od.getListOfUsers().setModel(model);
	 ...
	 * @param hour
	 */
	public void insertLine(String text, Style style, boolean hour) {
		try {
			if (hour) {
