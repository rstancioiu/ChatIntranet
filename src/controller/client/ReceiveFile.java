...
public class ReceiveFile implements Runnable {
	 ...
	 * @param language
	 */
	public ReceiveFile(InetAddress address, String file, int port, int size, PrivateChat privateChat,
			Language language) {
	...
	public void run() {
		try {
			privateChat.insertLine(language.getValue("DOWNLOAD_OF") + " " + fileName + " (" + size / 1000 + " Ko) ...",
